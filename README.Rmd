...
1 extracts **FIDELIO** model results from GDX files,
2 converts them to wide tables and computes **derived indicators** (nation, industry, trade),
3 saves outputs per symbol (Parquet/Feather/…) plus a **manifest** and optional **bundles**,
4 and ships two Shiny apps: an internal **diagnostic** app and a shareable **results** app.
